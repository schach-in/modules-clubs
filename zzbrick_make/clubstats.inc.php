...
function mod_clubs_make_clubstats() {
	...
	$sql = 'CREATE TABLE clubstats AS SELECT contact_id
		...
		LEFT JOIN contacts_identifiers
			ON IF(FIND_IN_SET(SUBSTRING(dwz_spieler.ZPS, 1, 1), "/*_SETTING ratings_dsb_federations_are_clubs _*/"), SUBSTRING(dwz_spieler.ZPS, 1, 3), IF(SUBSTRING(dwz_spieler.ZPS, 4, 2) = "00", SUBSTRING(dwz_spieler.ZPS, 1, 3), dwz_spieler.ZPS)) = contacts_identifiers.identifier
